...
import image from "../../assets/images/L.png";
...
import { ReactComponent as LoginSVG } from "../../assets/images/LS1.svg";
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="relative flex-1 flex justify-center items-center bg-gray-100">
        <LoginSVG className="w-3/4 h-3/4 text-blue-500" />
      </div>
      ...
      <div className="flex flex-col justify-center items-center flex-1 bg-gradient-to-r from-[#fcd9e1] to-[#fffdfd] px-6  sm:py-16">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-md space-y-6">
          ...
          <div>
            ...
            <p className="text-right text-sm text-gray-600 mt-1">
              <Link to={forgetPass} className="text-orange-950 hover:underline">
          ...
          <button
            type="submit"
            className="w-full py-2 bg-[#782033] text-white font-semibold rounded-lg hover:bg-blackfocus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        ...
        <p className="text-center text-sm text-gray-600 mt-4">
          {t("not_registered")}
          <Link to={signup} className="text-orange-950 hover:underline m-1">
            {t("register")}
          </Link>
        </p>
      </div>
